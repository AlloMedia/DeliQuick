...
const AddRestaurant = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post('http://localhost:3001/superadmin/add', formData, {
        headers: {
  ...
  return (
    <div className="container mx-auto p-4">
      <ToastContainer />
      <h2 className="text-2xl mb-4">Add New Restaurant</h2>
