...
router.put('/restaurants/reject-or-accept/:restaurantId', superAdminController.rejectOrAcceptRestaurant);
router.get('/Restaurant/unapproved', RestaurantController.getUnapprovedRestaurants);
